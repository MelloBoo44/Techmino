...
return {
    ...
    modes={
        ...
        ['secret_grade']=   {"Secret Grade",      "INVERTED WTF",   "Leave only a zig-zag mino formation!"},
        ...
        ['solo_u']=         {"Battle",            "WTF",            "Get as much attack as you can!"},
        ...
        ['round_u']=        {"Turn-Based",        "WTF",       		"Only 4 pieces per turn!"},
        ...
        ['backfire_u']=     {"Backfire",          "WTF",       		"Multiplied backfire!"},
        ['sprintAtk']=      {"Sprint",            "100 Attack WTF", "Send 100 lines in under 30s!"},
    ...
    getTip={refuseCopy=true,
        ...
        "Can you master hell?",
        "A thread on Techmino WTF is in the Techmino Discord.",
        "Excellent, but let’s go better next time…",
        "Find out what’s in the manual!",
        "Found any bugs? Open up an issue in our GitHub page!",
        "Got any suggestions? Post them in our Discord thread!",
        "Have you noticed what “skill issue” does do to a player?",
        ...
        "Techmino is so fun! Techmino WTF is not.",
        "Warning: skill issue",
        "What about 92 attack in battle?",
        "You are NOT a Grand Master!",
        {C.C,"Also try Techmino!"},
        {C.C,"Also try Techmino: Challenges!"},
        {C.C,"Also try playing more!"},
        {C.H,"REGRET!!"},
    },
