...
function scene.enter()
	...
	if errorInfo[1]=="Error:parts/eventsets/checkLine_10.lua:15: skill issue" then skillIssue=true else skillIssue=false end
	end
end
...
--if skillIssue~=1 then
scene.widgetList={
    WIDGET.newKey{name='console',x=940,y=640,w=170,h=80,font=65,fText=CHAR.icon.console,code=goScene'app_console',hideF=function() return skillIssue end},
    WIDGET.newKey{name='quit',x=1140,y=640,w=170,h=80,font=40,fText=CHAR.icon.cross_thick,code=goScene('quit','none'),hideF=function() return skillIssue end},
}
--end
